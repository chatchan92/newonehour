...
//白噪音幻灯片
 ...
 $('#ca').on("click", function(e){
  ...
  owl.owlCarousel();
      ...
      e.preventDefault();
      var content = "<div class=\"item\"><div id=\"slider3\"><iframe id=\"track\" src=\"ca\" frameborder=\"0\" ></iframe></div></div>";
 ...
 $('#un').on("click", function(e){
  ...
  owl.owlCarousel();
      ...
      e.preventDefault();
      var content = "<div class=\"item\"><div id=\"slider3\"><iframe id=\"track\" src=\"un\" frameborder=\"0\" ></iframe></div></div>";
      owl.data('owlCarousel').addItem(content);
      owl = $(".owl-carousel").data('owlCarousel');
      owl.goTo(3)
      check = 1;  
 ...
 $('#ac').on("click", function(e){
  ...
  owl.owlCarousel();
      ...
      e.preventDefault();
      var content = "<div class=\"item\"><div id=\"slider3\"><iframe id=\"track\" src=\"ac\" frameborder=\"0\" ></iframe></div></div>";
      owl.data('owlCarousel').addItem(content);
      owl = $(".owl-carousel").data('owlCarousel');
      owl.goTo(3)
      check = 1;  
 ...
 $('#fa').on("click", function(e){
  ...
  owl.owlCarousel();
      ...
      e.preventDefault();
      var content = "<div class=\"item\"><div id=\"slider3\"><iframe id=\"track\" src=\"fa\" frameborder=\"0\" ></iframe></div></div>";
      owl.data('owlCarousel').addItem(content);
      owl = $(".owl-carousel").data('owlCarousel');
      owl.goTo(3)
      check = 1;  
 ...
 $('#ra').on("click", function(e){
  ...
  owl.owlCarousel();
      ...
      e.preventDefault();
      var content = "<div class=\"item\"><div id=\"slider3\"><iframe id=\"track\" src=\"ra\" frameborder=\"0\" ></iframe></div></div>";
      owl.data('owlCarousel').addItem(content);
      owl = $(".owl-carousel").data('owlCarousel');
      owl.goTo(3)
      check = 1;  
...
$('#wi').on("click", function(e){
  ...
  owl.owlCarousel();
      ...
      e.preventDefault();
      var content = "<div class=\"item\"><div id=\"slider3\"><iframe id=\"track\" src=\"wi\" frameborder=\"0\" ></iframe></div></div>";
      owl.data('owlCarousel').addItem(content);
      owl = $(".owl-carousel").data('owlCarousel');
      owl.goTo(3)
      check = 1;  
